...
class DialogueBox extends FlxSpriteGroup
{
	...
	var skipFont:String = 'Pixel Arial 11 Bold';
	var skipFontScale:Int = 12;
	...
	{	
		...
		skipText = new FlxText(5, 695, 640, "Press S to skip the dialogue.\n", 12);
		skipText.scrollFactor.set(0, 0);
		skipText.font = curFont;
	...
	override function update(elapsed:Float)
	{
		...
		if(FlxG.keys.justPressed.S && !isEnding){
